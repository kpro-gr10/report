...
\subsection{Implementation}
	...
	\subsubsection{Power lines}
		\begin{itemize}
			...
			\item {\bf Selected houses when building power lines: }
		\end{itemize}
	...
	\subsubsection{Other implementations}
		\begin{itemize}
			...
			\item {\bf Win Game: }
			\item {\bf Power plant with Limited Power: }
	...
	\subsection*{Algorithms}
		...
		\subsubsection*{Breath First Search}
			...
			Algorithm courses. Breath First Search (from now on referred to as BFS) traverses a graph 
...
\subsection{Testing}
	...
	The following test cases were retested this sprint:
