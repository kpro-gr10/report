...
\subsection{Sprint backlog}
	...
	\begin{tabular}{| p{1.2cm} | p{8cm} | p{3cm} |}
		...
		FR2.8 & The user should be able to see information about buildings 
		when tapping on them. & \\ \hline
...
\subsection{Changes to the requirements}
	...
	\begin{tabular}{| p{1.5cm} | p{12cm} |}
		...
		FR 4.6 & [NEW] The user should be able to win the game by reaching the goal in the current level. The goal is level specific. \\ \hline
		FR6.11 & [NEW] The user should be able to see which houses is selected when building power cables. \\ \hline
		FR6.12 & [NEW] The cables should change color if it is connected to a power 
		station. \\ \hline
		FR6.13 & [NEW] The user should be able to see how much power the powerplant have left. 
