...
\subsection{Sprint backlog}
	...
	\begin{tabular}{| p{1cm} | p{8cm} | p{3cm} |}
		...
		FR4.3 & As the user reaches higher levels new buildings appear more rapidly. & Foreløpig ikke med i test kapittelet \\ \hline
...
\subsection{Testing}
	...
	\begin{tabular}{| p{2cm} | p{7cm} | p{2cm} |}
		...
		FT-10 Game Over & & \\ \hline
		FT-12 Collect Money & & \\ \hline
		FT-14 Building Mode & & \\ \hline
		FT-15 No Power and Health Bar & & \\ \hline
		FT-16 Information on building & & \\ \hline
	\end{tabular}
	...
	The test cases can be found in chapter XX.
