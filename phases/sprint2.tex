...
\subsection{Implementation}
	...
	\begin{itemize}
		...
		the level is showing in the hud. To get to the next level, the player needs to get the same
		amount of money as the goal in order to go to the next level.
...
\subsection{Group Dynamics}
	In the first sprint we had some problems with the group dynamics. 
	During this sprint we managed to work together as a group and the group dynamics
	are now very good. Allocation of roles in last sprint helped the group to work better.
