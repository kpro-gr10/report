...
\subsection{Duration and workload}
	...
	The scrum master have the responsability to ensure that the workload is met with the
	...
	since alle the group members are occupied with UKA, voluntary work and homework.
