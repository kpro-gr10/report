...
\centering
	\begin{tabular}{ l | p{8cm} }
		...
		Requirement & FR2.8 \\ 
		Pre-conditions & FT-02, FT-05. \\ 
		Steps of Execution & 1. Tap a building. \\
...
\centering
	\begin{tabular}{ l | p{8cm} }
		...
		Pre-conditions & FT-07. First the player does not have enough money. Subsequently the player does have enough money. \\ 
		...
		& 3. When having enough money the system reduces the players amount of money by the cost of the power plant, and upgrades the power plant. \\
	\end{tabular}
...
\centering
	\begin{tabular}{ l | p{8cm} }
		...
		& 4. The buildings bar disappears. \\
	\end{tabular}
...
\centering
	\begin{tabular}{ l | p{8cm} }
		...
		Test Id & FT-19 \\ 
		Feature to be tested & That different buildings have different power requirements. \\ 
		Requirement & FR3.3 \\ 
		Pre-conditions & FT-06, FT-07\\ 
		Steps of Execution &  \\ 
		Expected result & \\ 
	\end{tabular}
...
\centering
	\begin{tabular}{ l | p{8cm} }
		...
		Requirement & FR3.5 \\ 
		Pre-conditions & FT-20, ?MoreObstacles?\\ 
		Steps of Execution &  \\ 
		Expected result & \\ 
	\end{tabular}
	\caption{Functional test XX}
\end{table}