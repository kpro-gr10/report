...
\subsection{Internal Process and Results}
	...
	this goal. Nevertheless we completed the requirements in the specification apart from a few minor ones.
	...
	We felt that with one more person on the group this would have been possible, but could not 
	find the time and resources for it with the four of us.
