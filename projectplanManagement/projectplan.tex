\section{Project Plan}
	...
	is only an overview of the activities. Each sprint has its own activities, but
	...
	The first and the last week is reduced in number of days, so the total number of weeks is 13. \\
